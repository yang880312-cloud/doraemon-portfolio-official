...
<template>
  <div class="fixed bottom-8 left-1/2 -translate-x-1/2 z-40">
    <div class="flex items-center gap-4 p-4 rounded-full glass-panel bg-black/60 border border-white/10 shadow-2xl backdrop-blur-md transition-all duration-300">
      <button 
        ...
        :class="{ 'bg-blue-500/20 text-blue-300 ring-1 ring-blue-500/50': currentDim === item.id, 'text-gray-400': currentDim !== item.id }"
      >
